...
from scripts.CSVReader import CSV_Reader
...
""")
    ...
    def test_load_data_success(self):
        csv_reader = CSV_Reader(self.sample_file_path)
    ...
    def test_load_data_file_not_found(self):
        csv_reader = CSV_Reader(self.nonexistent_file_path)
        csv_reader.load_data()
        raw_data = csv_reader.get_data()
        self.assertIsNone(raw_data)  # Expecting None since file does not exist

    def test_load_data_empty_file(self):
        csv_reader = CSV_Reader(self.empty_file_path)
        csv_reader.load_data()
        raw_data = csv_reader.get_data()
